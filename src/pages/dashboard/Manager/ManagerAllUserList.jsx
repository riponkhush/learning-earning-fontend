                        ...
                        <CardBody className="overflow-x-scroll md:px-10 px-0 pt-0 pb-2">
                            {
                                loading ? (
                                    ...
                                    <thead>
                                        <tr className=''>
                                        {["author", "designation", "status"].map((el) => (
                                            <th
                                            key={el}
                                    ...
                                    <tbody className=''>
                                        {
                                            ...
                                            <div className="flex items-center gap-4">
                                                <Avatar src={'https://i.pinimg.com/736x/c3/01/8c/c3018c28d051c071032ae5faa9181b84.jpg'} alt="" size="sm" variant="rounded" />
                                                <div className=''>
                                                <Typography
                                                    variant="small"
                                                    color="blue-gray"
