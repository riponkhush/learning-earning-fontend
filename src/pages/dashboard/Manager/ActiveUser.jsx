            ...
            <Card>
                <CardHeader className="mb-8 md:p-6 p-3 bg-blue-500">
                    <div className='flex justify-between items-center'>
                        <Typography variant="h6" color="white">Active Student</Typography>
                                    ...
                                    {users.map(item =>
                                        <tr key={item._id}>
                                            ...
                                            <td className="py-3 px-5">
                                                ...
                                                >
                                                    <button className='bg-red-500 text-white w-20 rounded-full hover:bg-red-600 duration-500 shadow-xl'>Delete</button>
                                                </Typography >
                                            </td>
                                        </tr>
                                    )}
