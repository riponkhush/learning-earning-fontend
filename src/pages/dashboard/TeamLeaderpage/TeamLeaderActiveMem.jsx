...
const TeamLeaderActiveMem = () => {
    ...
    const { refetch, data: users = [] } = useQuery({
        ...
        queryFn: async () => {
            ...
            const activeuser = res.data.filter(activeUser => activeUser.status === "active" && activeUser.role === 'Trainer');
                ...
                <Card>
                    <CardHeader className="mb-8 md:p-6 p-3 bg-blue-500">
                        <div className='flex justify-between items-center'>
                            <Typography variant="h6" color="white">Active Member</Typography>
