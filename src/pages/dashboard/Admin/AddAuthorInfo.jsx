        ...
        const {
          ...
          const onSubmit = async (data) => {
            ...
            try {
              ...
              const response = await axiosPublic.post('/authorInfo', userInfo)
                ...
                <div>
                    <form onSubmit={handleSubmit(onSubmit)} className="px-7 h-[500px]">
                        <div className="grid gap-6" id="form">
                            ...
                            <input className="capitalize shadow-2xl p-3 ex w-full outline-none focus:border-solid focus:border-[1px] border-[#035ec5] placeholder:text-black" type="text" placeholder="Author name" id="" {...register("author_name", { required: true })}/>
                            </div>
                            <div className="grid gap-6 w-full">
                            <textarea className="p-3 shadow-2xl  glass w-full placeholder:text-black outline-none focus:border-solid border-[#035ec5] focus:border-[1px]" type="text" placeholder="About him/her" id="" {...register("about_him", { required: true })}/>
                            </div>
                            <div className="flex gap-3">
                            <input className="p-3 glass shadow-2xl  w-full placeholder:text-black outline-none focus:border-solid focus:border-[1px] border-[#035ec5]" type="text" placeholder="Dasignation" id=""  {...register("dasignation", { required: true })}/>
                            </div>
                            <div className="flex gap-3">
                            <input className="p-3 glass shadow-2xl  w-full placeholder:text-black outline-none focus:border-solid focus:border-[1px] border-[#035ec5]" type="email" placeholder="Email" id="" {...register("author_email", { required: true })}/>
                            </div>
                            <div className="flex gap-3">
