...
const CouncilorMappingSystem = () => {
    ...
    const { refetch, data: users = [] } = useQuery({
        ...
        queryFn: async () => {
            ...
            const activeUser = res.data.filter(userPerson => userPerson.role === 'Councilor');
    ...
    useEffect(() => {
        axiosPublic.get('/createUsers')
            .then(res => {
                const mappingMans = res.data.filter(mappingMan => mappingMan.role === 'Councilor');
    ...
    const handlePostToLeader = () => {
        ...
        setLoading(true);
        axiosPublic.post('/controllerMappingData', { councilorEmail: selectedLeader, councilorId: selectedUsers, loggedInUserEmail: user.email })
            .then(response => {
            ...
            <Card>
                <CardHeader className="mb-8 md:p-6 p-3 bg-blue-500">
                    <div className='flex justify-between items-center'>
                        <Typography variant="h6" color="white">Councilor Mapping  to Councilor</Typography>
                ...
                <div className='flex justify-between items-center py-3 px-5'>
                    <div className="md:w-72">
                        <Select label="Mapping with councilor" onChange={(value) => handleCouncilorChange(value)}>
